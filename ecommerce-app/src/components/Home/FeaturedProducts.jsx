...
const FeaturedProducts = ({ items }) => { // Data ab props se aa raha hai
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-screen-xl">
                    <div className="bg-white border border-gray-200 rounded-md flex flex-col md:flex-row overflow-hidden shadow-sm">
                        ...
                        <div className="p-6 border-b md:border-b-0 md:border-r border-gray-200 w-full md:w-[280px] shrink-0">
                            ...
                            <p className="text-gray-500 text-[15px] mb-4">Limited time offers</p>
                        ...
                        {/* ── RIGHT PANEL: DYNAMIC PRODUCTS (FROM PROPS) ── */}
                            ...
                            {items && items.length > 0 ? (
                                items.map((deal) => (
                                    <div
                                        ...
                                        className="flex-1 min-w-[180px] border-r border-gray-200 last:border-r-0 cursor-pointer"
                                    >
                                        <motion.div
                                        ...
                                        >
                                            ...
                                            <p className="text-[15px] text-[#1c1c1c] text-center mb-2 font-medium line-clamp-1">
                                                {deal.name}
                                            </p>
