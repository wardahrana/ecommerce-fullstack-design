        ...
        <>
            ...
            >
                ...
                <div
                    ...
                    className="w-full sm:w-48 h-48 shrink-0 flex items-center justify-center p-2 mb-4 sm:mb-0 bg-white rounded-xl hover:opacity-90 transition-opacity"
                ...
                <div className="flex flex-col flex-1 sm:ml-6 justify-center">
                    ...
                    <div className="mt-auto">
                        <button
                            onClick={handleImageClick}
                            className="text-blue-600 font-medium text-sm hover:underline inline-flex items-center group"
                        >
            ...
            {/* LoginModal — tab hi open hoga jab user logged out ho aur click kare */}
            <LoginModal
